...
from rest_framework_simplejwt.views import (
    TokenRefreshView as RF_TokenRefreshView,
    TokenVerifyView as RF_TokenVerifyView,
    TokenBlacklistView as RF_TokenBlacklistView,
)

urlpatterns = [
    path("api/v1/signup", SignupView.as_view(), name="signup"),
    path("api/v1/signin", SigninView.as_view(), name="signin"),
    path("api/v1/signout", RF_TokenBlacklistView.as_view(), name="signout"),
    path("api/v1/refresh", RF_TokenRefreshView.as_view(), name="refresh"),
    path("api/v1/verify", RF_TokenVerifyView.as_view(), name="verify"),
